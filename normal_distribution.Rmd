...
1.  What did we just do with the `filter` function?  (Hint: check out your new data frames)



1.  Make a plot (or plots) to visualize the distributions of the amount of calories
from fat of the options from these two restaurants.  Then apply the summary function to obtain 
quantify the distribution. Discuss their centers, shapes, and spreads compare?
